...
;(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME =
      'blaze-out/k8-opt/genfiles/third_party/mediapipe/web/solutions/face_mesh/face_mesh_solution_packed_assets.data'
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](
          'datafile_blaze-out/k8-opt/genfiles/third_party/mediapipe/web/solutions/face_mesh/face_mesh_solution_packed_assets.data'
        )
      }
  ...
  loadPackage({
    ...
    remote_package_size: 3986256,
    package_uuid: 'f5f855ab-ba1b-4fdf-8b0a-77c2c611502f',
  })
})()
