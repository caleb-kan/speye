...
export const createTextFromPreview = (
  ...
  return {
    ...
    llm_decision: textPreview.llm_decision,
    llm_violation_type: textPreview.llm_violation_type,
    admin_decision: textPreview.admin_decision,
...
export const createPreviewFromText = (textRecord: Text): TextPreview => {
  return {
    ...
    llm_decision: textRecord.llm_decision,
    llm_violation_type: textRecord.llm_violation_type,
    admin_decision: textRecord.admin_decision,
